...
// Test the fixed asset categories API endpoint
async function testFixedAssetCategories() {
  try {
    console.log('🧪 Testing Fixed Asset Categories API...');
    ...
    if (loginResponse.data.token) {
      ...
      if (categoriesResponse.data.success && categoriesResponse.data.data) {
        ...
        if (categories.length === 0) {
          console.log('\n⚠️  No categories found! This might be the issue.');
