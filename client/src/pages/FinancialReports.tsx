...
import { BarChart3, FileText, Calendar, Filter, TrendingUp, DollarSign, PieChart } from 'lucide-react';
...
const FinancialReports: React.FC = () => {
  const [activeReport, setActiveReport] = useState<'trial-balance' | 'income-statement' | 'balance-sheet' | 'cash-flow'>('trial-balance');
            ...
            <div className="bg-gray-100 p-4 rounded">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-bold text-gray-900">
                  {new Intl.NumberFormat('ar-LY').format(totalLiabilitiesAndEquity)}
                </span>
              </div>
            </div>
          </div>
