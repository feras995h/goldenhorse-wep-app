            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{selectedEmployee.salary.toLocaleString()} {selectedEmployee.currency}</p>
                </div>
                <div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{totals.salary.toLocaleString()}</div>
                  <div className="text-sm text-gray-600">إجمالي الرواتب</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-red-600">{totals.advances.toLocaleString()}</div>
                  <div className="text-sm text-gray-600">إجمالي السلف</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">{totals.bonds.toLocaleString()}</div>
