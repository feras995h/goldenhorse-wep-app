...
const InvoiceReports: React.FC = () => {
  ...
  const exportReport = () => {
    const csvContent = [
      ...
      ['إجمالي المبالغ', report.totalAmount.toLocaleString()],
      [''],
      ['الفواتير المسددة بالكامل', report.paidInvoices.toString()],
      ['مبلغ الفواتير المسددة', report.paidAmount.toLocaleString()],
      [''],
      ['الفواتير المسددة جزئياً', report.partiallyPaidInvoices.toString()],
      ['مبلغ الفواتير المسددة جزئياً', report.partiallyPaidAmount.toLocaleString()],
      [''],
      ['الفواتير غير المسددة', report.unpaidInvoices.toString()],
      ['مبلغ الفواتير غير المسددة', report.unpaidAmount.toLocaleString()],
      [''],
      ['الفواتير المتأخرة', report.overdueInvoices.toString()],
      ['مبلغ الفواتير المتأخرة', report.overdueAmount.toLocaleString()],
      [''],
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="mr-3">
                ...
                <p className="text-sm text-gray-500">{report.totalAmount.toLocaleString()} LYD</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="mr-3">
                ...
                <p className="text-sm text-gray-500">{report.paidAmount.toLocaleString()} LYD</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="mr-3">
                ...
                <p className="text-sm text-gray-500">{report.partiallyPaidAmount.toLocaleString()} LYD</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="mr-3">
                ...
                <p className="text-sm text-gray-500">{report.unpaidAmount.toLocaleString()} LYD</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="mr-3">
                ...
                <p className="text-sm text-gray-500">{report.overdueAmount.toLocaleString()} LYD</p>
              </div>
            </div>
          </div>
        </div>
