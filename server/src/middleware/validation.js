...
export const validateFixedAsset = [
  body('code')
    .trim()
    .isLength({ min: 1, max: 20 })
    .withMessage('Asset code must be between 1 and 20 characters'),
  ...
  commonValidations.amount('purchasePrice'),
  ...
  body('depreciationMethod')
    .isIn(['straight-line', 'declining-balance', 'sum-of-years'])
