...
console.log('🌱 Starting to seed final dummy data...');
...
const seedDummyDataFinal = async () => {
  try {
    ...
    // Create customers (without type field)
    ...
    console.log('🎉 Final dummy data seeding completed successfully!');
    console.log('📊 Summary:');
...
seedDummyDataFinal()
  .then(() => {
    console.log('✅ Final dummy data seeding completed');
    process.exit(0);
  })
  .catch((error) => {
    console.error('❌ Final dummy data seeding failed:', error);
    process.exit(1);
  });
